...
//    }
    ...
    public UserDetailsService userDetailsService() {
        ...
        manager.createUser(users.username("discUser").password("discPassword").roles("SYSTEM").build());
        return manager;
...
//                .anyRequest().denyAll().and().httpBasic().and().csrf()
//                .disable();
//    }
...
//        }
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.NEVER)
                    ...
                    .authorizeRequests().antMatchers(HttpMethod.GET, "/").hasRole("SYSTEM")
